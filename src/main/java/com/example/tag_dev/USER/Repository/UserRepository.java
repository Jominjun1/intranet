...
public interface UserRepository extends JpaRepository<User,Long> {
    ...
    @Query("SELECT u FROM User u WHERE u.userName = :user_name AND (u.userEmail = :user_email OR u.userPhoneNum = :user_phone_num)")
    ...
    @Query("SELECT u FROM User u WHERE u.userName = :user_name AND u.loginId = :login_id AND u.userEmail = :user_email AND u.userPhoneNum = :user_phone_num")
